            ...
            <div class="box">
                ...
                <table border="1" cellspacing="0" class="table">
                    ...
                    while($data_pelanggan = mysqli_fetch_assoc($query)):?>
                        ...
                        <td>
                                <a href="edit_pelanggan.php?id=<?php echo $data_pelanggan['id_pelanggan'] ?>">Edit</a>||<a href="hapus_pelanggan.php?idp=<?php echo $data_pelanggan['id_pelanggan'] ?>" onclick="return confirm('Anda yakin ingin menghapus data ini??')">Hapus</a>
                            </td>
